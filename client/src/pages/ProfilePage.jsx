...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      border-cyan-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-6 flex-1'>
          ...
          border-gray-500 rounded-md focus:outline-none focus:ring-2 
          focus:ring-cyan-500' rows={4}></textarea>
          <button type="submit" className='bg-gradient-to-r from-cyan-400 to-cyan-600 text-white p-2 rounded-full text-lg cursor-pointer'>
            Save
          </button>
        </form>
