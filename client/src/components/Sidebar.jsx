      ...
      <div className='pb-5'>
        <div className='flex justify-between item-center'>
            ...
            <div className='relative py-2 group'>
                ...
                bg-[#282142] border border-gray-600 text-gray-100  ${menuOpen ? 'block' : 'hidden'}
                group-hover:block`}>
        ...
        mt-5'> 
          ...
          text-white text-xs placeholder-[#c8c8c8] flex-1' placeholder='Search User...' /> {/* flex-1	Allows the element to grow and fill the available space inside a flex container (takes up remaining space)*/}
        </div>
